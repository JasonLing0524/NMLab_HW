...
class LogStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Show = channel.unary_unary(
                '/Log/Show',
                request_serializer=fib__pb2.LogRequest.SerializeToString,
                response_deserializer=fib__pb2.LogResponse.FromString,
                )
...
def add_LogServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Show': grpc.unary_unary_rpc_method_handler(
                    servicer.Show,
                    request_deserializer=fib__pb2.LogRequest.FromString,
                    response_serializer=fib__pb2.LogResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class Log(object):
    ...
    def Show(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Log/Show',
            fib__pb2.LogRequest.SerializeToString,
            fib__pb2.LogResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
